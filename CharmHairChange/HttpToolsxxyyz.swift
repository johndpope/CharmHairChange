...
func xyyxhttpConnect(abbx: String?, abby: String?, url:String, type:String, headers:[String:String], uploadDic:[String:Any]?, callback: @escaping (_ resultStatus:Int, _ resultHeaders:[String:String], _ resutlData:Data, _ resultError:String) -> Void) {
...
func xyyxdownloadJasonDataAsDictionary(abbx: String?, abby: String?, url:String, type:String, headers:[String:String], uploadDic:[String:Any]?, callback: @escaping (_ resutStatus:Int, _ resultHeaders:[String:String], _ resultDic:[String:Any], _ resultError:String) -> Void) {
    xyyxhttpConnect(abbx: nil, abby: nil, url: url, type: type, headers: headers, uploadDic: uploadDic) { (resultStatus, resultHeaders, resultData, errorString) in
...
func xyyxdownloadJasonDataAsArray(abbx: String?, abby: String?, url:String, type:String, headers:[String:String], uploadDic:[String:Any]?, callback: @escaping (_ resultStatus:Int, _ resultHeaders:[String:String], _ resultArray:[Any], _ resultError:String) -> Void) {
    xyyxhttpConnect(abbx: nil, abby: nil, url: url, type: type, headers: headers, uploadDic: uploadDic) { (resultStatus, resultHeaders, resultData, errorString) in
        DispatchQueue.main.async {
            do {
...
func xyyxdownloadImage(abbx: String?, abby: String?, url: String, callback: @escaping (UIImage?) -> Void) {
    xyyxhttpConnect(abbx: nil, abby: nil, url: url, type: "GET", headers: [String:String](), uploadDic: nil) { (resultStatus, resultHeaders, resultData, errorString) in
        DispatchQueue.main.async {
            if (resultStatus == 200) {
