...
class QueryDiscussTableViewCellxxyyz: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        subjectLabel.textColor = xyyxappSubColor
        subjectLabel.text = ""
        ...
        repostBtn.setTitleColor(xyyxappSubColor, for: UIControl.State.normal)
        likeBtn.setTitle("Like 0", for: UIControl.State.normal)
        likeBtn.setTitleColor(xyyxappSubColor, for: UIControl.State.normal)
