...
class KeyboardViewControllerxxyyz:UIViewController, UITextFieldDelegate {
    ...
    func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        ...
        if (kvcIsKeyboardShow) {
            ...
            let bottomInputViewFrame = xyyxkvcGetViewOfAbsoluteFame(abbx: nil, abby: nil, sourceView: kvcTargetView)
    ...
    func xyyxkvcGetViewOfAbsoluteFame(abbx: String?, abby: String?, sourceView:UIView) -> CGRect {
